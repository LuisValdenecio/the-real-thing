...
module.exports = {
			...
			app : function (app,io, users, dadosFaltas, professores, subjecInfo, studentsFaults, schoolRegister, classesInfo) {
								...
								client.query('SELECT "escola_cod" FROM escola WHERE nome_usuario = $1',
									...
									if (err) {
										...
										client.query('INSERT INTO turma (nome_class, curso_nome, turma_id, escola_cod, data_criacao) VALUES ($1, $2, $3, $4, $5)',
											[req.body["classe"], req.body["curso"], uuidv4(), resu.rows[0]["escola_cod"], helpers.getDate() ], function(err,result){
											if (err) {
												console.log(err);
											} else {
												console.log(result.rows);
