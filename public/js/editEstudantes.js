...
const secondLink = windows.location.pathname.split("_")[3];
/*
...
document.querySelector(".contact100-form").setAttribute("action", "/turma_"+linkURL+"_editarEstudante_"+secondLink);
